...
//
// Copyright 2021 The team gqgo Authors. All rights reserved.
// Use of this source code is governed by a MIT License
// license that can be found in the LICENSE file.
//
// gdev-i18n is a tool to automate the creation of methods that satisfy the fmt.Stringer, error
// interface. Given the name of a (signed or unsigned) integer type T that has constants
// defined, gdev-i18n will create a new self-contained Go source file implementing
...
func Usage() {
	_, _ = fmt.Fprintf(os.Stderr, "Usage of gdev-i18n:\n")
	_, _ = fmt.Fprintf(os.Stderr, "\tgdev-i18n [flags] -type T [directory]\n")
	_, _ = fmt.Fprintf(os.Stderr, "\tgdev-i18n [flags] -type T -tomlpath DIR -check # just for check\n")
	_, _ = fmt.Fprintf(os.Stderr, "\tgdev-i18n [flags] -type T -defaultlocale LOCALE -tomlpath DIR files... # Must be a single package\n")
	_, _ = fmt.Fprintf(os.Stderr, "For more information, see:\n")
	_, _ = fmt.Fprintf(os.Stderr, "\thttps://github.com/gqgo/gdev-i18n\n")
...
func main() {
	...
	g.Printf("// Code generated by \"gdev-i18n %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
...
func (g *Generator) generate(typeName string) {
	...
	g.Printf("\t// Re-run the gdev-i18n command to generate them again.\n")
...
// 新增
func (i %[1]s) TransErrorDetail() *I18n%[1]sDetail {
	return &I18n%[1]sDetail{ErrString: i._trans(_%[1]s_defaultLocale), ErrCode: uint(i), Locale: _%[1]s_defaultLocale}
}

// WrapWithContext wrap another error with context.Context set for i18n TYPE Const
//  - ctx context with Value use Key from _%[1]s_ctxKey, which pass by gdev-i18n flag -ctxkey
//  - err another error
//  - args optional formatting component
...
func (e *I18n%[4]sErrorWrap) Error() string {
	...
	return fmt.Sprintf("%[5]s (%[5]s)", e.Translate(), e.err.Error())
}
